...
const projects = [
  { id: 1,
    ...
    img_mobile: ['src/resources/prof.png'],
  ...
  { id: 3,
    ...
    img_mobile: ['https://res.cloudinary.com/le-wagon-785-vchang/image/upload/v1668784382/production/portfolio/metcog-mobile-hero_nzzibg.png','https://res.cloudinary.com/le-wagon-785-vchang/image/upload/v1668784375/production/portfolio/metcog-mobile-menu_ez6aii.png','https://res.cloudinary.com/le-wagon-785-vchang/image/upload/v1668784399/production/portfolio/metcog-mobile-ex_d2jl5a.png'],
  ...
  render() {
    ...
    return (
      <div className="Project-section">
        <button className="Button Project-btn-back" onClick={() => this.goBack()}>
        ...
        <button className="Button Project-btn-fwd" onClick={() => this.goForward()}>
